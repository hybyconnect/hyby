...
const DSWebDevelopment = () => {
  return (
    <div className="max-w-5xl mx-auto">
      <DSNavbar />
      <div className="h-[150px] p-2 flex justify-between bg-gray-100 shadow-md rounded  bg-yellow-400">
          <h2 className="text-white p-2"><span className="text-white p-2 text-bold text-3xl md:text-5xl">WebDevelopment</span> <br /> <span className=" text-black text-bold p-4">We Provide <br />  </span> <span className="text-white p-4 text-bold text-md md:text-xl">Best Websites and WebApps</span></h2>
...
export default DSWebDevelopment;